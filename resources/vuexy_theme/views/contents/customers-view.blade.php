                        ...
                        <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                            <div class="user-avatar-section">
                                <div class="d-flex justify-content-start">
                                    @if(auth()->user()->avatar != '')
                                        <img class="img-fluid rounded" src="{{asset(auth()->user()->avatar)}}" height="104" width="104">
                                    @else 
                                        <img class="img-fluid rounded" src="{{asset(env('APP_THEME').'/images/users/avatar-2.jpg')}}" height="104" width="104">
                                    @endif
        ...
        <div class="col-xl-3 col-lg-4 col-md-5">
            <div class="card plan-card border-primary">
                <div class="card-header d-flex justify-content-between align-items-center pt-75 pb-1">
                    ...
                    <span class="badge badge-light-secondary" data-toggle="tooltip" data-placement="top" title="Expiry Date">{{date('M d, Y',strtotime($customer['subscription_ends']))}} <span class="nextYear"></span>
                    </span>
                </div>
                <div class="card-body">
