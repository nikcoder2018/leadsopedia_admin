...
@section('content')
<section class="emailsubscribers-list-wrapper list-wrapper">
    <div class="card">
        <div class="card-datatable table-responsive">
            <table class="emailsubscribers-list-table list-table table">
                <thead>
                    <tr>
                        <th></th>
                        <th>Name</th>
...
@section('scripts')
<script src="{{asset(env('APP_THEME','default').'/app-assets/js/scripts/pages/app-emailsubscribers.js')}}"></script>
@endsection