        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center py-1">
                    ...
                    <a href="{{route('filter.industry.index')}}" class="btn btn-sm btn-primary">Industry</a>
                </div>
...
<div class="vertical-modal-ex">
    <div class="modal fade" id="add-industry-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('filter.industry.category.store')}}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="edit-industry-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="{{route('filter.industry.category.update')}}" method="POST">
                    @csrf
...
@section('scripts')
<script src="{{asset(env('APP_THEME','default').'/app-assets/js/scripts/pages/app-filters-industry-category.js')}}"></script>
@endsection