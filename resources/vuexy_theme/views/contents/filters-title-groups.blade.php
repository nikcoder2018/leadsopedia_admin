        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center py-1">
                    ...
                    <a href="{{route('filter.title')}}" class="btn btn-sm btn-primary">Titles</a>
                </div>
                <div class="card-datatable table-responsive">
                    <table class="group-list-table table">
                        <thead>
                            <tr>
                                <th>Name</th>
...
<div class="vertical-modal-ex">
    <div class="modal fade" id="add-title-group-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('filter.title.group.store')}}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="edit-title-group-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="{{route('filter.title.group.update')}}" method="POST">
                    @csrf
...
@section('scripts')
<script src="{{asset(env('APP_THEME','default').'/app-assets/js/scripts/pages/app-filters-title-group.js')}}"></script>
@endsection