        ...
        },
        {
            ...
            "mRender": function(data,type,row){
                return `
                    ...
                    <a href="#" class="text-danger archive-transaction" data-id="${row.id}" data-toggle="tooltip" data-placement="left" title="Archived"><i class="mdi mdi-delete-sweep icon-md"></i></a>
                `
            }
        }
      ],
