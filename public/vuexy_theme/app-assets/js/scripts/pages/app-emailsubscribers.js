$(async function() {
    ...
    var has_full_access = $.inArray('full_access', mypermissions) != -1 ? true : false,
        can_show_emailsubscribers = $.inArray('email_subscribers_show', mypermissions) != -1 ? true : false;

    var dtTable = $('.emailsubscribers-list-table'),
        isRtl = $('html').attr('data-textdirection') === 'rtl',
        API_URL = '/api/emailsubscribers/all',
